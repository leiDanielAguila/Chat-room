...
export function ChatBox(props: ChatBoxProps) {
  ...
  return (
    <div className="w-full h-96 overflow-y-auto p-4 border border-pink-300 rounded-lg shadow-2xl p-4 bg-rose-200">
...
export default function Home() {
  ...
  const [messages, setMessages] = React.useState<message[]>([placeholder]);
  return (
